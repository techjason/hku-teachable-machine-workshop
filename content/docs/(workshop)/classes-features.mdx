...
- Choose clearly different classes
- Start with 2-3 classes
- Add complexity gradually

### 2. Feature Consistency

- Maintain core features
- Vary non-essential features
- Document key characteristics

### 3. Training Data

- Capture variety within constraints
- Include edge cases
- Keep classes balanced

## Hands-on Exercise

Let's create a robust hand gesture classifier:

1. **Setup Classes**

   - Create three classes as described above
   - Name them clearly
   - Plan variations
