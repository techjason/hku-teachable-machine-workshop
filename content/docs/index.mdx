...
2. [Understanding Machine Learning Basics](/docs/ml-basics)
   ...
   - Types of Machine LearningOpen Chrome
   - Key terminology
...
Start with the [Getting Started](/docs/getting-started) guide to ensure you have everything needed for the workshop.

Created by [Jason Chan](https://techjason.com) (HKUMed 28')
