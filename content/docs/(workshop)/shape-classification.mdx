...
- Multiple classes (3 instead of 2)
- Natural ambiguity (octagons can look like circles)
- Rotation affects recognition
- Perfect for understanding model confusion
```
...
1. **Download the Training Images**
   ...
   - [Download Circle Images](/workshop-files/circles.zip)
   - [Download Square Images](/workshop-files/squares.zip)
   - [Download Octagon Images](/workshop-files/octagons.zip)

   Each zip contains:

   - 15 images of the shape
   - Various rotations
   - Different sizes
   - All in PNG format
...
1. **Rotation Effects**
   ...
   - Rotate squares 45° (diamond shape)
   - Rotate octagons slightly
   - Notice how confidence changes

2. **Distance/Size Effects**

   - Move shapes closer/further from camera
   - Make shapes larger/smaller
   - Observe confidence changes

3. **Edge Cases**
   - Show shapes at angles
   - Test with partially visible shapes
   - Try shapes with different thicknesses
